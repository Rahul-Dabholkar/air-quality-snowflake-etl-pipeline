...
create or replace table aqi_project_db.consumption_sch.weather_data as 
select 
    'India' as country,
    'Delhi' as state,
    'Delhi' as city,
...
-- check the data
select * from aqi_project_db.consumption_sch.weather_data order by measurement_dt;
...
as
insert into aqi_project_db.consumption_sch.weather_data select  
    'India' as country,
    'Delhi' as state,
    'Delhi' as city,
    DATE_VALID_STD as measurement_dt,
