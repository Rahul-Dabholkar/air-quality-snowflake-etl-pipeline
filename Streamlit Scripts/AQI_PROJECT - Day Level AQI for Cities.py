...
select 
    ...
    aqi 
from 
    aqi_project_db.consumption_sch.agg_city_fact_day_level
where 
    measurement_date = (select max(measurement_date) from aqi_project_db.consumption_sch.agg_city_fact_day_level)
order by aqi desc 
limit 10;
"""
